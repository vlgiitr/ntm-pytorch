...
# change the value from 'copy.json' to 'repeat_copy.json' for repeat copy task
# tasks/copy.json -> ntm/tasks/copy.json
task_json = "ntm/tasks/copy.json"

task_params = json.load(open(args.task_json))
# initialized dataset object. Have added delimiter in copy task.
daatset = CopyDataset(task_params)

# changed input_size. Incremented by one.
...
def train_batch(dataset):
    for idx in range(args.num_iters):
        # data is a dictionary returned by __getitem__ function
        data = dataset[idx]
